...
for difficulty_level, count in class_counts.items():
    if count < max_count:
        # Duplica con ripetizione casuale (sample con replace) gli esempi di questa classe fino a raggiungere max_count
...
model_name = "dbmdz/bert-base-italian-cased"  # modello BERT-base cased per italiano
